...
export const IS_PAIEMENT_RESERVATION_ACTIF = import.meta.env.VITE_PAIEMENT_RESERVATION_ACTIF === 'true';
export const IS_PAIEMENT_ABONNEMENT_ACTIF = import.meta.env.VITE_PAIEMENT_ABONNEMENT_ACTIF === 'true';
